...
const expectedPlain = fs.readFileSync(path.resolve(process.cwd(), '__fixtures__/expected_plain.txt'), 'utf-8');
const expectedStylish = fs.readFileSync(path.resolve(process.cwd(), '__fixtures__/expected_stylish.txt'), 'utf-8');
